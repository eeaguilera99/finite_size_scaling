...
p2_mat_0 = Matrix(CSV.read("dataMF/d=3_scaled_kinetic_energy_611.csv", DataFrame; header=false))
nc_mat_0 = Matrix(CSV.read("dataMF/d=3_scaled_nc_2_611.csv", DataFrame; header=false))              # ⟨p²⟩ values
