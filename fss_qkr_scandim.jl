...
for dim in d_values
    l_res, l_shifts, l_X, l_Y, l_Y_err = finite_time_scaling(K_vals, t_vals, p2_mat, p2_err_mat; d=dim, n_kicks_i=6),
    push!(collapse_quality, l_res.minimum)
...
println("   at kick index = ", n_Nkicks_i)

# Plot collapse quality vs dimension
plt_quality = plot(d_values, collapse_quality, lw=2, marker=:o,
